...
from .event_functions import drop_bomb_close_to_other, walked_towards_closest_coin, walked_from_danger, \
...
def game_events_occurred(
    ...
    if old_game_state is not None:
        ...
        if drop_bomb_close_to_other(old_feat, self_action) == 1:
            events.append(DROP_BOMB_CLOSE_TO_OTHER)
